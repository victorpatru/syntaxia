...
export const env = createEnv({
  server: {
    ...
    POLAR_PRODUCT_ID_1_SESSION: z.string().min(1).optional(),
    POLAR_PRODUCT_ID_3_SESSIONS: z.string().min(1).optional(),
    POLAR_PRODUCT_ID_5_SESSIONS: z.string().min(1).optional(),
    APP_URL: z.url(),
